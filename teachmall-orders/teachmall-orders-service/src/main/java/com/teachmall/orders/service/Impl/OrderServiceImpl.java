package com.teachmall.orders.service.Impl;
...
import com.teachmall.orders.config.AlipayConfig;
import com.teachmall.orders.config.PayNotifyConfig;
import com.teachmall.orders.mapper.XcOrdersGoodsMapper;
import com.teachmall.orders.mapper.XcOrdersMapper;
import com.teachmall.orders.mapper.XcPayRecordMapper;
...
import com.teachmall.orders.model.po.XcOrders;
import com.teachmall.orders.model.po.XcOrdersGoods;
import com.teachmall.orders.model.po.XcPayRecord;
import com.teachmall.orders.service.OrderService;
import com.teachmall.orders.utils.IdWorkerUtils;
import com.teachmall.orders.utils.QRCodeUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        if(orders==null){
            TeachmallException.cast("订单创建失败");
        }
        //生成支付记录
        ...
        try {
            ...
            TeachmallException.cast("生成二维码出错");
        }
    ...
    public PayRecordDto queryPayResult(String payNo){
        ...
        if (payRecord == null) {
            TeachmallException.cast("请重新点击支付获取二维码");
        }
        //支付状态
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo) {
        ...
        try {
            ...
            if (!response.isSuccess()) {
                TeachmallException.cast("请求支付查询查询失败");
            }
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto) {
        ...
        XcPayRecord payRecord = getPayRecordByPayno(payNo);
        if (payRecord == null) {
            TeachmallException.cast("支付记录找不到");
        }
        //支付结果
        ...
        if (trade_status.equals("TRADE_SUCCESS")) {
            ...
            if (totalPrice.intValue() != total_amount.intValue()) {
                ...
                TeachmallException.cast("校验支付结果失败");
            }
            ...
            if (update1 > 0) {
                ...
                TeachmallException.cast("更新支付记录状态失败");
            }
            //关联的订单号
            ...
            if (orders == null) {
                ...
                TeachmallException.cast("根据支付记录找不到订单");
            }
            ...
            if (update > 0) {
                ...
                TeachmallException.cast("更新订单表状态失败");
            }
            //保存消息记录,参数1：支付结果通知类型，2: 业务id，3:业务类型
            MqMessage mqMessage = mqMessageService.addMessage("payresult.notify", orders.getOutBusinessId(), orders.getOrderType(), null);
            //通知消息
    ...
    public XcPayRecord createPayRecord(XcOrders orders){
        if(orders==null){
            TeachmallException.cast("订单不存在");
        }
        if(orders.getStatus().equals("600002")){
            TeachmallException.cast("订单已支付");
        }

...
import com.teachmall.ucenter.mapper.XcUserRoleMapper;
...
import com.teachmall.ucenter.model.po.XcUserRole;
import com.teachmall.ucenter.service.AuthService;
import com.teachmall.ucenter.service.WxAuthService;
...
public class WxAuthServiceImpl implements AuthService, WxAuthService {
    ...
    @Value("${weixin.secret}")
    String secret;
    //注入自身代理对象解决事务失效的问题（非事务方法调用事务方法导致失效）
    @Lazy
    @Autowired

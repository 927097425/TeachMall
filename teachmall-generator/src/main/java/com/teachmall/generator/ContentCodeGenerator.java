package com.teachmall.generator;
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/teachmall-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://8.138.159.37:3306/teachmall_" + SERVICE_NAME
